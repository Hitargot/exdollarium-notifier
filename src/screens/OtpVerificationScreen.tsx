...
const OtpVerificationScreen = ({ route }: any) => {
    ...
    const handleOtpChange = (value: string, index: number) => {
        ...
        if (digits.length > 1) {
            ...
            const updatedOtp = [...pasted, ...Array(6 - pasted.length).fill('')].slice(0, 6);
            setOtp(updatedOtp);
            if (pasted.length === 6) {
                Keyboard.dismiss();
        ...
        >
            <View style={styles.content}>
                ...
                <View style={styles.card}>
                    <Text style={[styles.title, { color: tColors.primary }]}>Verification</Text>
                    ...
                    >
                        <Text style={[styles.resendText, resendTimer > 0 && { color: '#999' }]}>
                            {resendTimer > 0 
