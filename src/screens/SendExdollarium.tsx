...
const createStyles = (t: any) => StyleSheet.create({
    ...
    recipientSummary: { flexDirection: 'row', alignItems: 'center', marginBottom: 30, backgroundColor: t.colors?.surface || '#F8F9FC', padding: 15, borderRadius: 18 },
    ...
    currencyPrefix: { fontSize: 32, fontWeight: '800', color: t.colors.text, marginRight: 5 },
    amountInput: { fontSize: 48, fontWeight: '800', color: t.colors.text, minWidth: 100, textAlign: 'center' },
    presetsRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 30 },
    presetBtn: { paddingVertical: 10, paddingHorizontal: 14, borderRadius: 12, backgroundColor: t.colors?.surface || '#F1F5F9' },
    presetText: { fontWeight: '700', color: t.colors?.text || '#475569', fontSize: 13 },
    noteInput: { backgroundColor: t.colors?.surface || '#F8F9FC', borderRadius: 16, padding: 15, height: 100, textAlignVertical: 'top', marginBottom: 30, fontSize: 16, color: t.colors?.text || '#1E293B' },
